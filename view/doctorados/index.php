  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
    	<div class="NivelEducativo pt-7">IESSIC - IESA</div>
      	<div class="TituloCarreraCabecera">Doctorados</div><br>
	...
	<div class="row mt-15">
		...
		<div class="col-sm-12 col-md-12 col-lg-4">
			<div class="card-carreras text-center pt-27 pb-27">
				<a href="http://localhost/web-seuat/view/doctorados/educacion.php"><b>Educación</b></a><br>
				<small><b>Disponible en:</b> Tuxtla Gutiérrez, </small><small>Tapachula y </small><small>Reforma</small>
			</div>
		</div>

		<div class="col-sm-12 col-md-12 col-lg-4">
			<div class="card-carreras text-center pt-27 pb-27">
				<a href="http://localhost/web-seuat/view/doctorados/derecho.php"><b>Derecho</b></a><br>
